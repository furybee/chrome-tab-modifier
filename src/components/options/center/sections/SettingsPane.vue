      ...
      <div class="card-body">
        ...
        <div class="grid grid-cols-6 mt-4">
          <div class="col-span-5">
            ...
            <p>
              Enable "New version" toast, a tab is opened on each new version
      ...
      <div class="card-body">
        ...
        <div class="grid grid-cols-6">
          <div class="col-span-5">
            ...
            <p>
              Once you delete all rules, there is no going back except from
              backup. Please be certain.
            </p>
          </div>
          <div class="col-span-1">
            <button
              class="btn btn-sm btn-error btn-outline w-full"
              @click="onDeleteAllRules"
            >
              Delete
            </button>
          </div>
